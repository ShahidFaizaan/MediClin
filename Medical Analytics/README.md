...
Medical Intelligence is a comprehensive AI-driven platform that provides:
...
2. Run the application:
   ```bash
   streamlit run medical_intelligence.py
   ```
...
Database file: `medical_intelligence.db` (auto-created)
...
### Local Development
- Single file application: `medical_intelligence.py`
